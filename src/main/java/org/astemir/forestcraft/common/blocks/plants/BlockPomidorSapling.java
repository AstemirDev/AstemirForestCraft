...
public class BlockPomidorSapling extends CropsBlock implements ISeedable {

    public static final IntegerProperty POMIDOR_AGE = BlockStateProperties.AGE_0_3;
