...
public class StructureOldPlanters extends Structure<NoFeatureConfig> {



    public StructureOldPlanters() {
    ...
    public IStartFactory<NoFeatureConfig> getStartFactory() {
        return StructureOldPlanters.Start::new;
    }
        ...
        public void func_230364_a_(DynamicRegistries dynamicRegistryManager, ChunkGenerator chunkGenerator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn, NoFeatureConfig config) {
            ...
            JigsawManager.func_242837_a(
                    ...
                    new VillageConfig(() -> dynamicRegistryManager.getRegistry(Registry.JIGSAW_POOL_KEY)
                            .getOrDefault(new ResourceLocation(ForestCraft.MOD_ID, "old_planters/start_pool")),
                            10),
                    StructureOldPlantersPiece::new,
                    chunkGenerator,
                    templateManagerIn,
                    blockpos,
                    this.components,
    ...
    public static class StructureOldPlantersPiece extends AbstractVillagePiece {

        public StructureOldPlantersPiece(TemplateManager p_i242036_1_, JigsawPiece p_i242036_2_, BlockPos p_i242036_3_, int p_i242036_4_, Rotation p_i242036_5_, MutableBoundingBox p_i242036_6_) {
