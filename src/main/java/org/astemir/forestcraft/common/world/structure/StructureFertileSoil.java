...
public class StructureFertileSoil extends Structure<NoFeatureConfig> {



    public StructureFertileSoil() {
    ...
    public IStartFactory<NoFeatureConfig> getStartFactory() {
        return StructureFertileSoil.Start::new;
    }
        ...
        public void func_230364_a_(DynamicRegistries dynamicRegistryManager, ChunkGenerator chunkGenerator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn, NoFeatureConfig config) {
            ...
            JigsawManager.func_242837_a(
                    ...
                    new VillageConfig(() -> dynamicRegistryManager.getRegistry(Registry.JIGSAW_POOL_KEY)
                            .getOrDefault(new ResourceLocation(ForestCraft.MOD_ID, "fertile_soil/start_pool")),
                            10),
                    StructureFertileSoilPiece::new,
                    chunkGenerator,
                    templateManagerIn,
                    blockpos,
                    this.components,
    ...
    public static class StructureFertileSoilPiece extends AbstractVillagePiece {

        public StructureFertileSoilPiece(TemplateManager p_i242036_1_, JigsawPiece p_i242036_2_, BlockPos p_i242036_3_, int p_i242036_4_, Rotation p_i242036_5_, MutableBoundingBox p_i242036_6_) {
