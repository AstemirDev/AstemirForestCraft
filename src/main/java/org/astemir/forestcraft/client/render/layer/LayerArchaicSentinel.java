...
public class LayerArchaicSentinel<T extends Entity,M extends ModelRunestoneLord> extends AbstractEyesLayer {

    private static final RenderType OVERLAY = RenderType.getEyes(new ResourceLocation(ForestCraft.MOD_ID,"textures/entity/archaic_sentinel/archaic_sentinel_overlay.png"));

    public LayerArchaicSentinel(IEntityRenderer p_i226039_1_) {
        super(p_i226039_1_);
    }
