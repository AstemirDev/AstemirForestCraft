...
public class ModelBabyDandelioneer extends AnimatedEntityModel<EntityDandelioneer> {
	...
	public ModelBabyDandelioneer() {
		...
		body.setTextureOffset(0, 10).addBox(-2.0F, -7.0F, -2.0F, 5.0F, 7.0F, 4.0F, 0.0F, false);

		cap = new AModelRenderer(this);
		cap.setRotationPoint(1.0F, 3.0F, 0.0F);
		body.addChild(cap);
		cap.setTextureOffset(0, 0).addBox(-4.0F, -14.0F, -3.0F, 7.0F, 4.0F, 6.0F, 0.0F, false);

		hand0 = new AModelRenderer(this);
		hand0.setRotationPoint(-2.0F, -4.0F, 0.0F);
		body.addChild(hand0);
		hand0.setTextureOffset(18, 15).addBox(-2.0F, 0.0F, -1.0F, 2.0F, 3.0F, 2.0F, 0.0F, false);

		hand1 = new AModelRenderer(this);
		hand1.setRotationPoint(3.0F, -4.0F, 0.0F);
		body.addChild(hand1);
		hand1.setTextureOffset(18, 10).addBox(0.0F, 0.0F, -1.0F, 2.0F, 3.0F, 2.0F, 0.0F, false);

		leg0 = new AModelRenderer(this);
		leg0.setRotationPoint(-2.0F, -2.0F, 0.0F);
		whole_body.addChild(leg0);
		leg0.setTextureOffset(16, 20).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 2.0F, 2.0F, 0.0F, false);

		leg1 = new AModelRenderer(this);
		leg1.setRotationPoint(1.0F, -2.0F, 0.0F);
		whole_body.addChild(leg1);
		leg1.setTextureOffset(20, 0).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 2.0F, 2.0F, 0.0F, false);
		initializeAnimator(ModelDandelioneer.DANDELIONEER_ANIMATIONS);
	}
