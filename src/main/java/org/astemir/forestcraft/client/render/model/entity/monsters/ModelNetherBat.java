...
public class ModelNetherBat extends SegmentedModel<EntityNetherBat> {
	...
	@Override
	public void setRotationAngles(EntityNetherBat entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
