...
public class ModShieldItem extends ShieldItem implements IModItem<AShieldItem> {

    private AShieldItem constructor;
    ...
    @Override
    public AShieldItem itemConstructor() {
        return constructor;
    }

    @Override
    public ModShieldItem itemConstructor(AShieldItem constructor) {
    ...
    public boolean getIsRepairable(ItemStack toRepair, ItemStack repair) {
        return constructor.getIsRepairable(toRepair, repair);
    }
