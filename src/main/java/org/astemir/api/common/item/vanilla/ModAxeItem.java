...
public class ModAxeItem extends AxeItem implements IModItem<AItemAxe>, IModToolItem {


    private Multimap<Attribute, AttributeModifier> attributes;
    private AItemAxe constructor;

    private ImmutableMultimap.Builder<Attribute, AttributeModifier> attributeBuilder;

    public ModAxeItem(IItemTier tier, Properties builderIn, float attackDamage, float attackSpeed) {
    ...
    @Override
    public AItemAxe itemConstructor() {
        return constructor;
    }

    @Override
    public IModItem itemConstructor(AItemAxe constructor) {
