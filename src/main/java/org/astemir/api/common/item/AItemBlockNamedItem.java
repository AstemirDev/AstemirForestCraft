...
import org.astemir.api.common.item.vanilla.ModNamedBlockItem;

import javax.annotation.Nullable;
import java.util.List;


public class AItemBlockNamedItem extends AItem{

    private final Block block;

    public AItemBlockNamedItem(Block block) {
        super(block.getTranslationKey());
        this.block = block;
    }

    public AItemBlockNamedItem(String registryName, Block block) {
        super(registryName);
        this.block = block;
    }
    ...
    public Item build(Item.Properties properties) {
        ModNamedBlockItem blockItem = new ModNamedBlockItem(block,properties).itemConstructor(this);
        return blockItem;
    }
