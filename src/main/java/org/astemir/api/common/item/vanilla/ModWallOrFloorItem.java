...
public class ModWallOrFloorItem extends WallOrFloorItem implements IModItem<AItemWallOrFloor> {

    private AItemWallOrFloor constructor;


    public ModWallOrFloorItem(Block floorBlock,Block wallBlock, Properties builder) {
        super(floorBlock,wallBlock, builder);
    }

    @Override
    public AItemWallOrFloor itemConstructor() {
        return constructor;
    }

    @Override
    public ModWallOrFloorItem itemConstructor(AItemWallOrFloor constructor) {
