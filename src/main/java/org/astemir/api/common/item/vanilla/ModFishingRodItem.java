...
public class ModFishingRodItem extends FishingRodItem implements IModItem<AItemFishingRod> {

    private AItemFishingRod constructor;

    public ModFishingRodItem(Properties properties) {
        super(properties);
    }

    @Override
    public AItemFishingRod itemConstructor() {
        return constructor;
    }

    @Override
    public ModFishingRodItem itemConstructor(AItemFishingRod constructor) {
