...
public class ModBucketItem extends BucketItem implements IModItem<ABucketItem> {

    private ABucketItem constructor;

    public ModBucketItem(Supplier<Fluid> containedFluidIn, Properties properties) {
        super(containedFluidIn,properties);
    }

    @Override
    public ABucketItem itemConstructor() {
        return constructor;
    }

    @Override
    public ModBucketItem itemConstructor(ABucketItem constructor) {
