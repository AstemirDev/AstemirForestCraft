...
public class ModNamedBlockItem extends BlockNamedItem implements IModItem<AItemBlockNamedItem> {

    private AItemBlockNamedItem constructor;


    public ModNamedBlockItem(Block blockIn, Properties builder) {
        super(blockIn, builder);
    }

    @Override
    public AItemBlockNamedItem itemConstructor() {
        return constructor;
    }

    @Override
    public ModNamedBlockItem itemConstructor(AItemBlockNamedItem constructor) {
