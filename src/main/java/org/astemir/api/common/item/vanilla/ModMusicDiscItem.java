...
import org.astemir.api.common.item.AItemMusicDisc;
...
public class ModMusicDiscItem extends MusicDiscItem implements IModItem<AItemMusicDisc> {

    private AItemMusicDisc constructor;


    public ModMusicDiscItem(Supplier<SoundEvent> soundSupplier, Properties builder) {
        super(1, soundSupplier, builder);
    }

    @Override
    public AItemMusicDisc itemConstructor() {
        return constructor;
    }

    @Override
    public ModMusicDiscItem itemConstructor(AItemMusicDisc constructor) {
