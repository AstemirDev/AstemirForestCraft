...
public class ModPickaxeItem extends PickaxeItem implements IModItem<AItemPickaxe>, IModToolItem {


    private Multimap<Attribute, AttributeModifier> attributes;
    private AItemPickaxe constructor;

    private ImmutableMultimap.Builder<Attribute, AttributeModifier> attributeBuilder;

    public ModPickaxeItem(IItemTier tier, Properties builderIn, float attackDamage, float attackSpeed) {
    ...
    @Override
    public AItemPickaxe itemConstructor() {
        return constructor;
    }

    @Override
    public IModItem itemConstructor(AItemPickaxe constructor) {
