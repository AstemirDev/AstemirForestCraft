...
import org.astemir.api.common.item.AItemTool;
...
public class ModToolItem extends ToolItem implements IModItem<AItemTool>, IModToolItem {


    private Multimap<Attribute, AttributeModifier> attributes;
    private AItemTool constructor;

    private ImmutableMultimap.Builder<Attribute, AttributeModifier> attributeBuilder;

    public ModToolItem(IItemTier tier, Properties builderIn, float attackDamage, float attackSpeed) {
        super( 0, 0,tier,null, builderIn);
        attributeBuilder = new ImmutableMultimap.Builder();
        attributeBuilder.put(Attributes.ATTACK_DAMAGE, new AttributeModifier(ATTACK_DAMAGE_MODIFIER, "Tool modifier", attackDamage, AttributeModifier.Operation.ADDITION));
        attributeBuilder.put(Attributes.ATTACK_SPEED, new AttributeModifier(ATTACK_SPEED_MODIFIER, "Tool modifier", attackSpeed, AttributeModifier.Operation.ADDITION));
    }
    ...
    @Override
    public AItemTool itemConstructor() {
        return constructor;
    }

    @Override
    public IModItem itemConstructor(AItemTool constructor) {
