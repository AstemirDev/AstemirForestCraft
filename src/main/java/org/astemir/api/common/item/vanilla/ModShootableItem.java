...
public class ModShootableItem extends ShootableItem implements IModItem<AShootableItem> {

    private AShootableItem constructor;

    public ModShootableItem(Properties properties) {
        super(properties);
    }

    @Override
    public Predicate<ItemStack> getInventoryAmmoPredicate() {
        return constructor.getInventoryAmmoPredicate();
    }

    @Override
    public AShootableItem itemConstructor() {
        return constructor;
    }

    @Override
    public ModShootableItem itemConstructor(AShootableItem constructor) {
