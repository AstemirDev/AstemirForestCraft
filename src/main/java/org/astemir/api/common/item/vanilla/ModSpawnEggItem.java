...
public class ModSpawnEggItem extends ForgeSpawnEggItem implements IModItem<AItem> {

    private AItem constructor;

    public ModSpawnEggItem(Supplier<EntityType<?>> typeIn, int primaryColorIn, int secondaryColorIn, Properties properties) {
        super(typeIn,primaryColorIn,secondaryColorIn,properties);
    }

    @Override
    public AItem itemConstructor() {
        return constructor;
    }

    @Override
    public ModSpawnEggItem itemConstructor(AItem constructor) {
