...
import org.astemir.api.common.item.AItemHoe;
...
public class ModHoeItem extends HoeItem implements IModItem<AItemHoe>, IModToolItem {


    private Multimap<Attribute, AttributeModifier> attributes;
    private AItemHoe constructor;

    private ImmutableMultimap.Builder<Attribute, AttributeModifier> attributeBuilder;

    public ModHoeItem(IItemTier tier, Properties builderIn, float attackDamage, float attackSpeed) {
    ...
    @Override
    public AItemHoe itemConstructor() {
        return constructor;
    }

    @Override
    public IModItem itemConstructor(AItemHoe constructor) {
