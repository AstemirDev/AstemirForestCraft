...
import org.astemir.api.common.item.vanilla.ModBowItem;

public class ABowItem extends AShootableItem{


    public ABowItem(String registryName) {
        super(registryName);
        ammo(ARROWS);
    }
    ...
    public Item build(Item.Properties properties) {
        ModBowItem bowItem = (ModBowItem) new ModBowItem(properties).itemConstructor(this);
        return bowItem;
    }
            ...
            if (!itemstack.isEmpty() || flag) {
                ...
                if (!((double)f < 0.1D)) {
                    ...
                    if (!worldIn.isRemote) {
                        ...
                        abstractarrowentity = createArrow(abstractarrowentity);
    ...
    public AbstractArrowEntity createArrow(AbstractArrowEntity arrow) {
        return arrow;
    }
