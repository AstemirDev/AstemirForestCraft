...
public class ModBowItem extends BowItem implements IModItem<ABowItem> {

    private ABowItem constructor;
    ...
    @Override
    public ABowItem itemConstructor() {
        return constructor;
    }

    @Override
    public ModBowItem itemConstructor(ABowItem constructor) {
