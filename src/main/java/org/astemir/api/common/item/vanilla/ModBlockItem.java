...
public class ModBlockItem extends BlockItem implements IModItem<AItemBlockItem> {

    private AItemBlockItem constructor;
    ...
    @Override
    public AItemBlockItem itemConstructor() {
        return constructor;
    }

    @Override
    public ModBlockItem itemConstructor(AItemBlockItem constructor) {
