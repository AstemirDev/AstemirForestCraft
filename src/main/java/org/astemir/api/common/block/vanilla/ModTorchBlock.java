...
public class ModTorchBlock extends TorchBlock implements IModBlock<ATorchBlock> {

    private ATorchBlock constructor;

    public ModTorchBlock(Properties properties, IParticleData data) {
    ...
    @Override
    public ATorchBlock blockConstructor() {
        return constructor;
    }
    ...
    @Override
    public IModBlock blockConstructor(ATorchBlock constructor) {
