...
import org.astemir.api.common.block.ARotatedPillarBlock;
import org.astemir.api.common.block.IModBlock;

import javax.annotation.Nullable;
import java.util.Random;

public class ModRotatedPillarBlock extends RotatedPillarBlock implements IModBlock<ARotatedPillarBlock> {

    private ARotatedPillarBlock constructor;
    ...
    @Override
    public ARotatedPillarBlock blockConstructor() {
        return constructor;
    }
    ...
    @Override
    public IModBlock blockConstructor(ARotatedPillarBlock constructor) {
