...
public class ModOreBlock extends OreBlock implements IModBlock<AOreBlock> {

    private AOreBlock constructor;
    ...
    @Override
    public AOreBlock blockConstructor() {
        return constructor;
    }
    ...
    @Override
    public IModBlock blockConstructor(AOreBlock constructor) {
