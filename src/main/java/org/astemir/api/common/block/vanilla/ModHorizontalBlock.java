...
public class ModHorizontalBlock extends HorizontalBlock implements IModBlock<AHorizontalBlock> {

    private AHorizontalBlock constructor;

    public ModHorizontalBlock(Properties properties) {
        super(properties);
    }
    ...
    @Override
    public AHorizontalBlock blockConstructor() {
        return constructor;
    }
    ...
    @Override
    public IModBlock blockConstructor(AHorizontalBlock constructor) {
