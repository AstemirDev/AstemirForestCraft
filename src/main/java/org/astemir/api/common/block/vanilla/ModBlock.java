...
public class ModBlock extends Block implements IModBlock<ABlock> {

    private ABlock constructor;
    ...
    @Override
    public ABlock blockConstructor() {
        return constructor;
    }
    ...
    @Override
    public IModBlock blockConstructor(ABlock constructor) {
