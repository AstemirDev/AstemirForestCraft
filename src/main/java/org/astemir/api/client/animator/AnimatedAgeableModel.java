...
public abstract class AnimatedAgeableModel<E extends Entity> extends AnimatedEntityModel<E> {
    ...
    protected AnimatedAgeableModel(boolean p_i225943_1_, float p_i225943_2_, float p_i225943_3_) {
        this(p_i225943_1_, p_i225943_2_, p_i225943_3_, 2.0F, 2.0F, 24.0F);
    }

    protected AnimatedAgeableModel(boolean p_i225944_1_, float p_i225944_2_, float p_i225944_3_, float p_i225944_4_, float p_i225944_5_, float p_i225944_6_) {
        this(RenderType::getEntityCutoutNoCull, p_i225944_1_, p_i225944_2_, p_i225944_3_, p_i225944_4_, p_i225944_5_, p_i225944_6_);
    }

    protected AnimatedAgeableModel(Function<ResourceLocation, RenderType> p_i225942_1_, boolean p_i225942_2_, float p_i225942_3_, float p_i225942_4_, float p_i225942_5_, float p_i225942_6_, float p_i225942_7_) {
        super(p_i225942_1_);
    ...
    protected AnimatedAgeableModel() {
    ...
    protected abstract Iterable<AModelRenderer> getHeadParts();

    protected abstract Iterable<AModelRenderer> getBodyParts();
}
